    ...
    <div v-if="this.$auth.loggedIn" class="sidebaritems">
      ...
      >
        <NuxtLink :to="menuitem.url">
          ...
          <svg
            v-else-if="menuitem.label.toLowerCase().startsWith('skill tree')"
            xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink"
            version="1.1"
            x="0px"
